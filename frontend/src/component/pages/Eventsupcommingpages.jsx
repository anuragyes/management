...
import { EventUpcommingCutural, EventUpcommingWorkstartup, EventUpcommingHackaThon, EventUpcommingSport, EventUpcommingWorkshop, EventUpcommingSeminar } from '../../ApiInstance/Allapis';
const EventsPage = () => {
    ...
    const fetchCategoryData = async (category) => {
        try {
            ...
            if (category === 'all') {
                // Fetch all events by combining data from all categories
                const promises = Object.entries(categoryEndpoints).map(([cat, endpoint]) =>

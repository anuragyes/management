...
import { OrgainserRegsiter } from '../ApiInstance/Allapis';
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                console.warn("REGISTER FAILED ", response.data.message);
        ...
        <div className={`min-h-screen flex items-center justify-center ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
            <div className={`w-full max-w-md p-8 rounded-lg shadow-lg transition-all duration-300 ${theme === 'dark'
                ...
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold mb-2">Oraginser  Registration</h1>
